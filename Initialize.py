...
MainOffice = Room("Main Office", "main", [OfficeDesk, OfficeFloor], "You enter the main office. Mr. Bals immediately comes out of his personal office.", NPCs = [Bals], lock="main office key")
NurseOffice = Room("Nurse's Office", "nurse", [NurseCabinet, NurseFloor], "You enter the nurse\'s office. Next to Mrs. Finley's desk there is a cabinet. In the corner there is a bed.", specialActions = {"sleep":"Sleep on the bed"}, NPCs = [])
Rm125 = Room("Mrs. LeBlanc's Room", "125", [Rm125Closet, Rm125Floor], "You enter room 125. There is a closet near the door. Suddenly, black lines swarm out of a math textbook.", NPCs = [Mob])
