...
MainOffice = Room("Main Office", "main", [OfficeDesk, OfficeFloor], "You enter the main office. Mr. Bals immediately comes out of his personal office.", specialActions = {}, NPCs = Bals, lock="main office key")
...
Rm125 = Room("Mrs. LeBlanc's Room", "125", [Rm125Closet, Rm125Floor], "You enter room 125. There is a closet near the door. Suddenly, black lines swarm out of a math textbook.", specialActions = {}, NPCs = Mob)
Rm180 = Room("Mr. B's Room", "180", [Rm180Floor], "You enter room 180. Mr. B sits behind his computer. Stay Honest In Testing devices are on the shelf.", specialActions = {}, NPCs = Borchardt)