...
TechLab = Room("Tech Lab", "tech", [TechCabinet], "There are some wood scraps on the work tables and multiple closets and cabinets along the walls.", light=False, lock="tech lab key")
